...
export default function ThreeEditViewNewEditForm({ currentThree }) {
  ...
  const initial_ar = currentThree?.lang?.ar.apps || []
  const initial_en = currentThree?.lang?.en.apps || []
  const initial_cr = currentThree?.lang?.cr.apps || []
  /////////////////////////////////////////////
  ...
  const defaultValues = useMemo(
    () => ({
      titleOne_ar: currentThree?.lang?.ar?.titleOne || '',
      titleOne_en: currentThree?.lang?.en?.titleOne || '',
      titleOne_cr: currentThree?.lang?.cr?.titleOne || '',

      titleTow_ar: currentThree?.lang?.ar?.titleTow || '',
      titleTow_en: currentThree?.lang?.en?.titleTow || '',
      titleTow_cr: currentThree?.lang?.cr?.titleTow || '',

      span_ar: currentThree?.lang?.ar?.span || '',
      span_en: currentThree?.lang?.en?.span || '',
      span_cr: currentThree?.lang?.cr?.span || '',

      descriptionOne_ar: currentThree?.lang?.ar?.descOne || '',
      descriptionOne_en: currentThree?.lang?.en?.descOne || '',
      descriptionOne_cr: currentThree?.lang?.cr?.descOne || '',

      descriptionTow_ar: currentThree?.lang?.ar?.descTow || '',
      descriptionTow_en: currentThree?.lang?.en?.descTow || '',
      descriptionTow_cr: currentThree?.lang?.cr?.descTow || '',

      appsList_ar: currentThree?.lang?.ar?.apps ||'',
      appsList_en: currentThree?.lang?.en?.apps ||'',
      appsList_cr: currentThree?.lang?.cr?.apps ||'',
  ...
  }, [currentThree, defaultValues, reset]);
  ...
  const onSubmit = handleSubmit(async (data) => {
      ...
      try{
        const newArray_ar = await Promise.all(values?.appsList_ar.map(async(item, index) => {
          ...
          if(currentThree?.lang?.ar?.apps[index]?.img){
            await axiosReq.post('/deleteFile', {
              fileUrl: currentThree?.lang?.ar?.apps[index]?.img
            })
          }
        ...
        const newArray_en = await Promise.all(values?.appsList_en.map(async(item, index) => {
          if (typeof item.img === 'object'){
          if(currentThree?.lang?.en?.apps[index]?.img){
            await axiosReq.post('/deleteFile', {
              fileUrl: currentThree?.lang?.en?.apps[index]?.img
            })
          }
        ...
        const newArray_cr = await Promise.all(values?.appsList_cr.map(async(item, index) => {
          if (typeof item.img === 'object'){
          if(currentThree?.lang?.cr?.apps[index]?.img){
            await axiosReq.post('/deleteFile', {
              fileUrl: currentThree?.lang?.cr?.apps[index]?.img
            })
          }
...
ThreeEditViewNewEditForm.propTypes = {
  currentThree: PropTypes.object,
};
