...
export const PATH_LOGIN = paths.auth.root; // as '/login'
export const PATH_SIGN_UP = paths.auth.signup; // as 'signup'
export const PATH_FORGOT_PASSWORD = paths.auth.forgotpassword; // as 'forgotpassword'
