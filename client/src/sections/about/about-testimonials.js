    ...
    >
      ...
      <m.div variants={varFade().inUp}>
        <Typography sx={{ color: 'common.white' }}>
          نتطلع دائمًا لتلبية توقعاتك وتحقيق رضاك الكامل. نجعل هدفنا الرئيسي هو خدمتك بأعلى مستويات
          الجودة والتفوق. نسعى لتوفير تجربة سفر وخدمات لوجستية استثنائية، تجمع بين الابتكار والتميز
          في كل جوانبها. نحن نسعى لتسهيل تجربتك وجعلها مريحة وفعّالة، سواء أكان ذلك من خلال خدمات
          السفر المتميزة أو التعامل مع شركات التوصيل الرائدة مثل FedEx، UPS، وDHL.
        </Typography>
      </m.div>
